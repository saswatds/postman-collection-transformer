...
_.assign(Builders.prototype, {
    ...
    /**
     *
     * @param {Object} requestV1 - The v1 request to extract the request protocol from.
     * @returns {String} - The extracted protocol
     */
    protocol: function (requestV1) {
        return { type:  requestV1.protocol || 'http'}; // Default to http being the protocol
    },
    ...
    request: function (requestV1) {
        var self = this,
            ...
            units = ['auth', 'method', 'header', 'body', 'url', 'protocol'];
